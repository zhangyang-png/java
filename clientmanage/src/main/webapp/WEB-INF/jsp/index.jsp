						...
						<a href="" class="public-header-man public-header-right">待办<span
							...
							<ul class="daiban">
								...
								<li class="daibanli">待处理的办公审批<span
									style="color: red; font-weight: 200;">0</span></li>
							</ul></a> <a href="clock.action" class="public-header-man public-header-right">${clock.daka }</a>
			...
			<div class="public-ifame-leftnav">
				...
				<ul class="left-nav-list">
					<li class="public-ifame-item"><a href="javascript:;">客户管理</a>
						<div class="ifame-item-sub">
							<ul>
								...
								<li><a href="#" target="content">客户池</a></li>
								<li><a href="#" target="content">客户联系人</a></li>
								<li><a href="#" target="content">附近客户</a></li>
								<li><a href="#" target="content">沟通日志</a></li>
							</ul>
						</div></li>
					...
					<li class="public-ifame-item"><a href="javascript:;">财务管理</a>
						<div class="ifame-item-sub">
							<ul>
								<li><a href="#" target="content">应收款</a></li>
								<li><a href="#" target="content">应付款</a></li>
								<li><a href="#" target="content">回款单</a></li>
								<li><a href="#" target="content">付款单</a></li>
								<li><a href="#" target="content">发票</a></li>
							</ul>
						</div></li>
					...
					<li class="public-ifame-item"><a href="javascript:;">数据分析</a>
						<div class="ifame-item-sub">
							<ul>
								<li><a href="#" target="content">数据分析</a></li>
							</ul>
						</div></li>
					<li class="public-ifame-item"><a href="javascript:;">工单任务</a>
						<div class="ifame-item-sub">
							<ul>
								<li><a href="#" hhref="" target="content">工单</a></li>
								<li><a href="#" hhref="" target="content">任务</a></li>
							</ul>
						</div></li>
					<li class="public-ifame-item"><a href="javascript:;">办公</a>
						<div class="ifame-item-sub">
							<ul>
								...
								<li><a href="#" target="content">审批</a></li>
								<li><a href="#" target="content">知识</a></li>
								<li><a href="#" target="content">公告</a></li>
								<li><a href="#" target="content">定位签到</a></li>
								<li><a href="#" target="content">日程</a></li>
								<li><a href="#" target="content">考勤日历</a></li>
								<li><a href="#" target="content">通讯录</a></li>
							</ul>
						</div></li>
					<li class="public-ifame-item"><a href="javascript:;">营销</a>
						<div class="ifame-item-sub">
							<ul>
								<li><a href="#" target="content">市场活动</a></li>
								<li><a href="#" target="content">发送邮件</a></li>
							</ul>
						</div></li>
