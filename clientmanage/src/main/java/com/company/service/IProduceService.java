...
public interface IProduceService {
	...
	public boolean addProduce(@Param("name") String name,@Param("price") String price,@Param("kind") int kind,@Param("desc") String desc,@Param("count") int count,@Param("imgStr") String imgStr);
	
	public boolean updateProduce(@Param("id") int id,@Param("name") String name,@Param("price") String price,@Param("kind") int kind,@Param("desc") String desc,@Param("count") int count,@Param("imgStr") String imgStr);
