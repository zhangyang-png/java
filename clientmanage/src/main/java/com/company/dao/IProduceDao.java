...
public interface IProduceDao {
	 ...
	 * 添加产品
	 */
	public int addProduce(@Param("name") String name,@Param("price") String price,@Param("kind") int kind,@Param("desc") String desc,@Param("count") int count,@Param("imgStr") String imgStr);
	
	/**
	 * @param produce
	 * 修改产品
	 */
	public int updateProduce(@Param("id") int id,@Param("name") String name,@Param("price") String price,@Param("kind") int kind,@Param("desc") String desc,@Param("count") int count,@Param("imgStr") String imgStr);
