...
public class ProduceController {
	...
	public String saveProduce(@Param("name") String name, @Param("price") String price, @Param("kind") int kind,
			@Param("desc") String desc, @Param("count") int count, @Param("imgStr") String imgStr) {
		boolean flag = produceService.addProduce(name, price, kind, desc, count, "123");
		if (flag) {
	...
	public String saveProduceUpdate(@Param("id") int id, @Param("name") String name, @Param("price") String price,
			...
			@Param("imgStr") String imgStr, HttpServletRequest request, HttpServletResponse response) {
		boolean flag = produceService.updateProduce(id, name, price, kind, desc, count, "123");
		if (flag) {
			return "redirect:findlist.action";
		} else {
			return "updateproduce";
